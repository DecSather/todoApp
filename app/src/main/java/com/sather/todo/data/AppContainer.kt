...
interface AppContainer {
    ...
    val diariesRepository: DiariesRepository
}
...
class AppDataContainer(private val context: Context): AppContainer {
    ...
    override val diariesRepository: DiariesRepository by lazy { DiariesRepository(BacklogDatabase.getDatabase(context).diaryDao()) }
}